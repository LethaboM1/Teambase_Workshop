		...
		if( $('#gaugeBasic').get(0) ) {
			var target = $('#gaugeBasic'),
				opts = $.extend(true, {}, {
					...
					colorStart: '#f3b426', // Colors
					colorStop: '#f3b426', // just experiment with them
