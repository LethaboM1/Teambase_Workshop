    ...
    <section class="card card-featured-left card-featured-<?= $status_color ?> mb-4">
        <div class="card-body">
            ...
            <a class="mb-1 mt-1 mr-1 modal-sizes" href="#modalassign_<?= $jobcard['job_id'] ?>">
                ...
                ?>
                <p class="card-subtitle"><b>Logged by:</b><?= $logged_by_['name'] ?><br><?= $jobcard['fault_description'] ?><br><b>Mechanic:</b><?= $$mechanic_['name'] ?> <?= $$mechanic_['last_name'] ?><br><?= $jobcard['fault_description'] ?></p>
            </a>
        </div>
    </section>
</div>
