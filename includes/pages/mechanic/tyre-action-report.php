						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('1_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('2_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('3_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('4_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('5_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('6_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('7_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('8_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('9_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('10_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('11_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
						...
						<div class="col-lg-6">
							<div style="border: 1px solid white; border-radius: 3px;" class="p-1 m-1">
								<div class="row m-1">
									...
									<div class="col-lg-3"><?= inp('12_pressure', 'Pressure', 'number', '', '', 0, '', 'step="0.1"') ?></div>
								</div>
								<div class="row">
