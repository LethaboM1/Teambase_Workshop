...
switch ($_GET['page']) {
	...
	case 'daily-pre-task-mini':
		...
		$page_name = 'daily-pre-task-mini';
		break;

	case 'plant-inspection':
		$page_title = 'Plant Inspection / Job Instruction Report';
		$page_name = 'plant-inspection';
		break;

	case 'defect-report':
		$page_title = 'Defect Report';
		$page_name = 'defect-report';
		break;

	case 'plant-schedule':
		$page_title = 'Plant Service Schedule';
		$page_name = 'plant-schedule';
		break;

	default:
		$page_title = 'Dashboard Overview';
		$page_name = 'dashboards/mechanic_dash';
}
?>
	...
	<section class="body">
		...
		<div class="inner-wrapper">
			...
			<aside id="sidebar-left" class="sidebar-left">
				...
				<!-- Navigation Start -->
				<? include('navigation/mech_nav.php'); ?>
