			...
			<section class="card card-featured-left card-featured-warning mb-4">
				<div class="card-body">
					<div class="card-actions">
						...
						<!-- Assign Job Card -->
						<!-- Modal Assign -->
						<a class="mb-1 mt-1 mr-1 modal-sizes" href="#modalassign2"><i class="fa-solid fa-handshake-angle"></i></a>
						<div id="modalassign2" class="modal-block modal-block-lg mfp-hide">
								<section class="card">
								<header class="card-header">
								<h2 class="card-title">Assign Job Card</h2>
								</header>
			...
			<section class="card card-featured-left card-featured-danger mb-4">
				<div class="card-body">
					<div class="card-actions">
						...
						<!-- Assign Job Card -->
						<!-- Modal Assign -->
						<a class="mb-1 mt-1 mr-1 modal-sizes" href="#modalassign3"><i class="fa-solid fa-handshake-angle"></i></a>
						<div id="modalassign3" class="modal-block modal-block-lg mfp-hide">
								<section class="card">
								<header class="card-header">
								<h2 class="card-title">Assign Job Card</h2>
								</header>
