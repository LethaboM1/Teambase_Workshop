...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>TeamBase | Hillary Construction | Recover Password</title>
	...
	<body>
		...
		<section class="body-sign">
			<div class="center-sign">
				<div class="main_logo"><img src="img/logos/teambase_logo.png" height="169" alt="Porto Admin" />
				</div>
				<div class="panel card-sign">
					...
					<div class="card-body">
						...
						<form>
							...
							<p class="text-center mt-3">Remembered? <a href="index.php">Sign In!</a></p>
						</form>
					</div>
				</div>

				<p class="text-center text-muted mt-3 mb-3">TeamBase &copy; Copyright 2022. All Rights Reserved.</p>
			</div>
		</section>
		<!-- end: page -->
